...
def compare_api():
    ...
    if is_properties:
        ...
        try:
            ...
            # --- LÓGICA REFEITA PARA MOSTRAR APENAS AS DIFERENÇAS ---
                ...
                if tag == 'equal':
                    ...
                    for old_line, new_line in zip_longest(old_block, new_block):
                        ...
                        if old_line is not None and new_line is not None:
                            changes += 1 # Contabiliza como uma alteração
